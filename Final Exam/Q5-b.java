...
class Client {
    ...
    class connector{
        public static <Clienthandler> void main(String []arg) throws IOException{
            Vector<Clienthandler> ch=new Vector<>();
            ...
            try{
                ...
                while(true){
                    ...
                    try{
                        ...
                        Clienthandler Ch=new Clienthandler(inFromClient,outFromClient);
